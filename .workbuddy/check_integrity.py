...
# 2026 中秋+国庆（上交所公告〔2026〕22号）：
#   中秋 9/25（周五）休市（9/26-27 为周末）；国庆 10/1（周四）~10/7（周三）休市（10/3-4 为周末）。
# 只登记**非周末**的法定休市日（周末由 trading_days 的 weekday()<5 天然排除）。
HOLIDAYS = {
    '2026-09-25',  # 中秋
    '2026-10-01', '2026-10-02', '2026-10-05', '2026-10-06', '2026-10-07',  # 国庆（工作日）
}
