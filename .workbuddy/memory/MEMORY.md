...
- 方向量化打分（2026-09-08 重构）：~~趋势因子日/周线 ±2~~ **已废除**（current_trend 滞后慢变量，震荡市永远 down 方向命中率<50%，负贡献）；**买卖点只当「点位锚」不当「方向锚」**（精准命中极值 61.9% 是支撑/压力第一来源，但滞后不用来判方向，方向分只取近期 60F/15F 弱权重 ±1）；**confidence 降权**（无背驰一买/一卖 confidence<0.6 降半权，回测相反率 30.3%→28.2%）；**MACD 动能因子 ±1**；**时效信号因子（方向主判，新增）**：T&J 定调 ±2 + BOLL 变盘概率（60F/日线偏离 50% 超 15pct ±1）+ MACD DIF 拐头 ±1；总分 **≥2 偏多、≤-2 偏空、|总分|≤1 或 15F BOLL 带宽<1% → 方向不明不硬猜**（给 A/B 双向剧本）
